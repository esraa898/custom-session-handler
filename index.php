...
define('SESSION_SAVE_PATH', dirname(realpath(__FILE__)).DIRECTORY_SEPARATOR.'class');
class AppSessionHandler  extends \SessionHandler 
{
 ...
 private $ivlen;
  ...
  public function read($id)
   {
    ...
    if(!$data){
     ...
     return openssl_decrypt($data, $this->sessionCipherAlgo, $this->sessionCipherKey,true, $this->iv);
    }
   }
  ...
  public function write($id , $data)
  {
      ...
      return parent::write($id, openssl_encrypt($data, $this->sessionCipherAlgo, $this->sessionCipherKey,true, $this->iv));
  }
...
public function setSessionStartTime(){
  ...
  private function checkSessionValidaty(){
